...
const createSection1A20 = {
  body: Joi.object().keys({
    ...
    hosmobileno: Joi.string()
      .regex(/^\d{10}$/)
      .optional(),
    schoolCategoryId: Joi.string().required(),
    lowestclassschool: Joi.string().trim(),
    highestclassschool: Joi.string().trim(),
    schoolpreprimary: Joi.string().trim(),
    ...
    managementgroup: Joi.string().trim(),
    ManagementcodeId: Joi.string().required(),
    managementcodeSchool: Joi.string().trim(),
